...
def enter_schedule_from_bundle(schedule_bundle, debug=False):
    error_log = []
...
def enter_schedule(schedule_json, debug=False):
...
error_log = enter_schedule_from_bundle(bundle, debug=False)
